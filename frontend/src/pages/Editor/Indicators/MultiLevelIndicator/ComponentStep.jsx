...
export default function ComponentStep(props) {
    ...
    const selectIndicators = useSelector((state) => state.multiLevelEditorReducer.selectedData.indicators);
    ...
    const analysisMethodOutputsData = useSelector((state) => state.multiLevelEditorReducer.fetchedData.analysisMethodOutputs);
    ...
    const handleOpenVisualization = () => {
        ...
        dispatch(generateMultiLevelIndicatorPreview(getMultiLevelIndicatorPreviewCode));
    ...
    const STEPS = [
        ...
        {
            name: "Analysis",
            component: <StepAnalysis classes={classes} onStepComplete={handleStepComplete} onStepIncomplete={handleStepIncomplete} />,
            color: '#8bc34a'
        },
        {
            name: "Visualization",
