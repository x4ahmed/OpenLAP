export const attributeDataFunction = (resultData) => {
  let attributes = [
    ...
    {
      id: "statement.verb.display.en-US",
      type: "Text",
      required: true,
      name: "Actions",
      displayName: "Action",
      description: "Selected list of actions performed on the activity(ies). E.g. a list of actions " +
        "performed on a course are e.g. \"viewed\", \"enrolled\" etc."
    },
    {
      id: "statement.stored",
      type: "Numeric",
      ...
      displayName: "Selected Timeframe",
